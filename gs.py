...
Original file is located at
    https://colab.research.google.com/drive/1Bft8SmjiJ9A7UoCu3CUlrUhoLUvnBS5C
"""

import random
import time

ALTURA_TOTAL_RESERVATORIO_CM = 100.0
LIMIAR_ATENCAO_PERCENT = 0.30
LIMIAR_CRITICO_PERCENT = 0.70

DADOS_SENSOR_SIMULADOS = [
    5.0, 10.0, 15.0, 20.0, 25.0,
    30.0, 35.0, 40.0, 50.0, 60.0, 69.0,
    70.0, 75.0, 85.0, 95.0,
    105.0,
    -5.0,
    10.0
